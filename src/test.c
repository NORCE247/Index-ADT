 ...
 * There is no guarantee that you will be able to run past a SEGFAULT.
 */
...
int test_index(void)
{
    ...
    else if (cmpfunc((void *)completed, "hamlet") != 0 && cmpfunc((void *)completed, "Hamlet") != 0)
    {
        num_failed++;
