 ...
 * @version 0.1
 *
 * Defines the interface for a linked list, (implementation is of a doubly
 * linked list).
 */
#ifndef LIST_H
#define LIST_H
 ...
 *
 * @warning Subsequently accessing the list leads to undefined behaviour. The
 * elements of the list are not destroyed.
 ...
 * @return int Returns 1 if there are more elements, 0 if the iterator is at the
 * end.
 */
int list_hasnext(list_iter_t *iter);

/**
 * @brief Returns the current element of the iterator and advances it one step
 * forward.
 *
 * @param iter The iterator of the list.
 * @return void* The current element pointed to by the iterator. NULL if there
